...
BEGIN
	...
	cst_id,
	cst_key,
	-- Removing Unwanted Spaces to ensure Data consistency
	TRIM(cst_firstname) AS cst_firstname,
	TRIM(cst_lastname) AS cst_lastname,
	-- Data Normalzation & Standardization( Normalize marital status to readable format)
	-- Handling Missing Data
	CASE WHEN UPPER(TRIM(cst_marital_status)) ='M' THEN 'Married'
		 WHEN UPPER(TRIM(cst_marital_status)) ='S' THEN 'Single'
		 ELSE 'n/a'
	END cst_marital_status,
	-- Nomalize gender values to readable format
	...
	*,
	...
	CAST(
		...
		AS DATE
	)AS prd_end_dt -- Calculate end date as day before the start date
